 ...
 * {@link net.neoforged.neoforge.event.entity.EntityLeaveLevelEvent} (players excluded so dimension travel
 * does not clear), and {@link net.neoforged.neoforge.event.server.ServerStoppingEvent}.
 */
