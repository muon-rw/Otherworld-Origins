...
public final class RepairMaterialDescription {
    ...
    public static Component collapsedLine() {
        return Component.translatable("raven_dnd_origins.tooltip.repair_materials_hold_shift")
    ...
    public static List<Component> expandedLines(ItemStack stack) {
        ...
        lines.add(Component.translatable("raven_dnd_origins.tooltip.repair_materials_header")
                .withStyle(ChatFormatting.GRAY));
        if (!stack.isRepairable()) {
            lines.add(Component.translatable("raven_dnd_origins.tooltip.not_repairable").copy());
        } else {
