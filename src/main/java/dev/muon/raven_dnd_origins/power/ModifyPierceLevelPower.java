...
public class ModifyPierceLevelPower extends PowerType<ModifyPierceLevelPower.Configuration> {
    ...
    public static float modify(Entity entity, float baseValue) {
        ...
        PowerLookup.forEach(entity, ModPowers.MODIFY_PIERCE_LEVEL, Configuration.class,
    ...
    public static boolean hasPower(Entity entity) {
        ...
        return container != null && !container.powersOfType(ModPowers.MODIFY_PIERCE_LEVEL).isEmpty();
    }
