...
public class ModifyProjectileVelocityPower extends PowerType<ModifyProjectileVelocityPower.Configuration> {
    ...
    public static float modify(Entity entity, float baseValue) {
        ...
        PowerLookup.forEach(entity, ModPowers.MODIFY_PROJECTILE_VELOCITY, Configuration.class,
    ...
    public static boolean hasPower(Entity entity) {
        ...
        return container != null && !container.powersOfType(ModPowers.MODIFY_PROJECTILE_VELOCITY).isEmpty();
    }
