...
public class ClientServerPlayerEventsMixin {
    ...
    private static void raven_dnd_origins$skipClientCancelForCommandCast(Consumer<?> consumer,
                                                                        Operation<Void> operation) {
        if (ClientMagicData.isCasting()
                && ClientMagicDataAccessor.raven_dnd_origins$getPlayerMagicData().getCastSource() == CastSource.COMMAND) {
            return;
        }
