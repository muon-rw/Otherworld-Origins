...
public class ClientInputEventsMixin {
    ...
    private static boolean raven_dnd_origins$allowAttackDuringCommandCast(boolean isCasting) {
        if (isCasting && ClientMagicDataAccessor.raven_dnd_origins$getPlayerMagicData().getCastSource() == CastSource.COMMAND) {
            return false;
        }
        return isCasting;
    }
