...
@Mixin(value = S2CDynamicRegistryPacket.Login.class, remap = false)
public abstract class S2CDynamicRegistryLoginPacketMixin {

    @ModifyExpressionValue(
            method = "create",
            at = @At(value = "CONSTANT", args = "intValue=1048576")
    )
    private static int otherworldorigins$raiseLoginSplitLimit(int prior) {
