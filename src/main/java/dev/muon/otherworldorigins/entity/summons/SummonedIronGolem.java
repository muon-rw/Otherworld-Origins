...
public class SummonedIronGolem extends IronGolem implements IFollowingSummon, ISummon {
    /*
    ...
    static {
        OWNER_UUID = IFollowingSummon.getOwnerUUIDAccessor(SummonedIronGolem.class);
    }
    public SummonedIronGolem(EntityType<? extends IronGolem> entityType, Level level) {
    ...
    public EntityType<?> getType() {
        return ModEntities.SUMMON_IRON_GOLEM.get();
    }
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(2, new HurtByTargetGoal(this, SummonedIronGolem.class){
            @Override
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return Mob.createMobAttributes().add(Attributes.MAX_HEALTH, 50.0D).add(Attributes.MOVEMENT_SPEED, 0.25D).add(Attributes.KNOCKBACK_RESISTANCE, 1.0D).add(Attributes.ATTACK_DAMAGE, 10.0D);
    }
