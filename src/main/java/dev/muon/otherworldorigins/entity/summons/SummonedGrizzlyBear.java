...
public class SummonedGrizzlyBear extends EntityGrizzlyBear implements IFollowingSummon, ISummon {
    ...
    static {
        OWNER_UUID = IFollowingSummon.getOwnerUUIDAccessor(SummonedGrizzlyBear.class);
    }
    public SummonedGrizzlyBear(EntityType<? extends EntityGrizzlyBear> entityType, Level level) {
    ...
    public EntityType<?> getType() {
        return ModEntities.SUMMON_GRIZZLY_BEAR.get();
    }
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(2, new HurtByTargetGoal(this, SummonedGrizzlyBear.class){
            @Override
