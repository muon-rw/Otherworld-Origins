...
public class ModPowers {
    ...
    public static final RegistryObject<PowerFactory<NoConfiguration>> PREVENT_TEMPERATURE = POWER_FACTORIES.register("prevent_temperature", PreventTemperaturePower::new);
